...
class VLMManager:
    def __init__(self):
        ...
        self.model = ImageDetectionModel.load_from_checkpoint("./model/vlm_model-epoch=00-val_loss=32.70.ckpt", num_classes=8)
    ...
    def preprocess_text(self, text):
        clip_text = self.model.clip_processor(text=text, return_tensors="pt")
        return clip_text
    ...
    def identify(self, image: bytes, caption: str) -> List[int]:
        ...
        return self.convert_bbox_to_dimensions(box)
